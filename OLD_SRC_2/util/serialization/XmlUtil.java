...
public final class XmlUtil {
    ...
    @Nonnull
    public static Element getAnyChildElement(@Nonnull Element parent){

        Element element = findAnyElement(parent.getChildNodes());
        if(element == null){
    ...
    public static Element getChildElement(@Nonnull String name, @Nonnull Element parent, Element def){

        Element element = findAnyElement(parent.getElementsByTagName(name));
        if(element == null){
            return def;
        }
        return element;
    ...
    @Nonnull
    public static Element getChildElement(@Nonnull String name, @Nonnull Element parent){
    ...
    @Nullable
    private static Element findAnyElement(@Nullable NodeList list){
    ...
    @Nonnull
    public static Iterable<Attr> getAllAttrs(@Nonnull Node node) {
