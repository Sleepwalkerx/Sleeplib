...
import com.sleepwalker.sleeplib.ui.xml.ShapeSerializer;
...
public class OvalShape extends BaseShape {
    ...
    public static class Serializer extends ForgeRegistryEntry<ShapeSerializer> implements ShapeSerializer {
        ...
        @Nonnull
        @Override
        public Shape deserialize(@Nonnull Element element, @Nonnull DeserializeContext context) throws XmlParseException {
