...
public interface DeserializeContext {
    ...
    @Nullable Drawable findDrawableCache(@Nonnull ResourceLocation resourceLocation);
    void addDrawableToCache(@Nonnull ResourceLocation resourceLocation, @Nonnull Drawable drawable);

    class Impl implements DeserializeContext {
