...
package com.sleepwalker.sleeplib.gg.essential.universal.wrappers.message

import com.sleepwalker.sleeplib.gg.essential.universal.utils.MCClickEventAction
import com.sleepwalker.sleeplib.gg.essential.universal.utils.MCHoverEventAction
import com.sleepwalker.sleeplib.gg.essential.universal.UChat
...
//#endif
    ...
    private fun reInstance() {
        ...
        //#else
        component = StringTextComponent(text.formatIf(formatted))
        //#endif
    ...
    fun appendElem(text: ITextComponent): IFormattableTextComponent = component.appendSibling(text)

    //#if MC<11900
    override fun setStyle(style: Style): IFormattableTextComponent = component.setStyle(style)

    override fun appendSibling(sibling: ITextComponent): IFormattableTextComponent = component.appendSibling(sibling)
    ...
    companion object {
        fun from(obj: Any): UTextComponent? {
            return when (obj) {
                ...
                is ITextComponent -> UTextComponent(obj)
                else -> null
            }
        }
