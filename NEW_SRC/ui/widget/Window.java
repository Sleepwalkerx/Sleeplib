...
public class Window implements WidgetGroup, IGuiEventListener, IRenderable, Root {
    ...
    @Nonnull
    private final ListenerStack<PointerEvent> pointerDownEventListeners = ListenerStack.newStack();
    @Nonnull
    private final ListenerStack<PointerEvent> pointerUpEventListeners = ListenerStack.newStack();
    @Nonnull
    private final ListenerStack<PointerEvent> pointerMoveEventListeners = ListenerStack.newStack();
    @Nonnull
    private final ListenerStack<PointerEvent> pointerEnterEventListeners = ListenerStack.newStack();
    @Nonnull
    private final ListenerStack<PointerEvent> pointerOutEventListeners = ListenerStack.newStack();
    @Nonnull
    private final ListenerStack<PointerEvent> pointerScrollEventListeners = ListenerStack.newStack();

    private Screen screen;

    @Nonnull
    protected final DynamicCanvas canvas;
    @Nonnull
    protected final DynamicPointer pointer;
    ...
    public void updatePitchedState(@Nonnull Pointer pointer){
        if(pinched){
            WidgetReleasedEventHandler.fireIfInstance(pointer, content);
            pinched = false;
        }
    }
    ...
    public DynamicPropertyMap getDynamicPropertyMap() {
        return DynamicPropertyMap.EMPTY;
    }
