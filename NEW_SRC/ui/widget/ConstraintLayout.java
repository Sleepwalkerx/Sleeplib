...
import com.sleepwalker.sleeplib.ui.math.RectSide;
...
public class ConstraintLayout extends BaseLayoutGroupWidget {
    ...
    @Nonnull public static final SideAttach DEFAULT_ATTACH_LEFT = new SideAttach(WidgetReferences.parent(), RectSide.LEFT);
    @Nonnull public static final SideAttach DEFAULT_ATTACH_RIGHT = new SideAttach(WidgetReferences.parent(), RectSide.RIGHT);
    @Nonnull public static final SideAttach DEFAULT_ATTACH_TOP = new SideAttach(WidgetReferences.parent(), RectSide.TOP);
    @Nonnull public static final SideAttach DEFAULT_ATTACH_BOTTOM = new SideAttach(WidgetReferences.parent(), RectSide.BOTTOM);
    ...
    public static class SideAttachProperty<T extends Widget> extends BaseProperty<T, SideAttach> {

        public SideAttachProperty(@Nonnull SideAttach defaultValue, @Nonnull Class<T> hostType, @Nonnull Listener<T, SideAttach> listener) {
            super(defaultValue, hostType, listener);
        }

        @Nonnull
        @Override
        public SideAttach fromXml(@Nonnull Attr attr, @Nonnull T host) throws XmlParseException {
