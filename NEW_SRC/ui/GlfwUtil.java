...
public class GlfwUtil {
    ...
    public static void enableScissorTest(float x, float y, float width, float height) {
    ...
    public static void drawRect(@Nonnull MatrixStack ms, float x, float y, float z, float width, float height, int colorHex){
        ...
        drawRect(ms.last().pose(), x, y, z, width, height, r, g, b, a);
    ...
    public static void drawRect(@Nonnull Matrix4f mat, float x, float y, float z, float width, float height, float r, float g, float b, float a){
        ...
        buffer.vertex(mat, x + width, y,          z).color(r, g, b, a).endVertex();
        buffer.vertex(mat, x,         y,          z).color(r, g, b, a).endVertex();
        buffer.vertex(mat, x,         y + height, z).color(r, g, b, a).endVertex();
        buffer.vertex(mat, x + width, y + height, z).color(r, g, b, a).endVertex();
        tessellator.end();
    }
    ...
    public static void drawRoundedHollowRect(
        ...
        buffer.vertex(mat, pX2 + aX, pY2 + aY, z).color(r, g, b, a).endVertex();

        aX = (float) (Math.sin(radians) * radiusRB);
        aY = (float) (Math.cos(radians) * radiusRB);
        buffer.vertex(mat, pX + aX, pY + aY, z).color(r, g, b, a).endVertex();
    ...
    public static void drawDoublePie(
        ...
        for(int i = 0; i <= vertexCount; i++){
            ...
            buffer.vertex(mat, x2 + aX, y2 + aY, z).color(r, g, b, a).endVertex();

            aX = (float) (Math.sin(radians) * radius1);
            aY = (float) (Math.cos(radians) * radius1);
            buffer.vertex(mat, x1 + aX, y1 + aY, z).color(r, g, b, a).endVertex();
        }
    }
    ...
    public static void drawRoundedRect(
        ...
        buffer.vertex(x + width / 2, y + height / 2, z).color(r, g, b, a).endVertex();
        drawPie(mat, buffer, x + width - radiusRB, y + height - radiusRB, z, radiusRB, 0f,   14, r, g, b, a);
        drawPie(mat, buffer, x + width - radiusRT, y + radiusRT,          z, radiusRT, 90f,  14, r, g, b, a);
        drawPie(mat, buffer, x + radiusLT,         y + radiusLT,          z, radiusLT, 180f, 14, r, g, b, a);
        drawPie(mat, buffer, x + radiusLB,         y + height - radiusLB, z, radiusLB, 270f, 14, r, g, b, a);
        buffer.vertex(mat, x + width - radiusRB, y + height, z).color(r, g, b, a).endVertex();
    ...
    public static void drawPie(
        ...
        for(int i = 0; i <= vertexCount; i++){
            ...
            buffer.vertex(mat, x + aX, y + aY, z).color(r, g, b, a).endVertex();
        }
    }
    ...
    public static void drawEllipse(@Nonnull MatrixStack ms, float x, float y, float z, float width, float height, int vertexCount, int colorHex){
        ...
        buffer.begin(GL11.GL_TRIANGLE_FAN, DefaultVertexFormats.POSITION_COLOR);
        buffer.vertex(mat, cx, cy, z).color(r, g, b, a).endVertex();
        float deg = 360f / vertexCount;
        for(int i = vertexCount; i >= 0; i--){
            float rad = (float) Math.toRadians(deg * i);
            buffer.vertex(mat, MathHelper.cos(rad) * hw + cx, MathHelper.sin(rad) * hh + cy, z).color(r, g, b, a).endVertex();
        }
        tessellator.end();
    ...
    public static void drawHollowEllipse(@Nonnull MatrixStack ms, float x, float y, float z, float width, float height, float thickness, int vertexCount, int colorHex){
        ...
        for(int i = vertexCount; i >= 0; i--){
            ...
            buffer.vertex(mat, sin * hw + cx, cos * hh + cy, z).color(r, g, b, a).endVertex();
            buffer.vertex(mat, sin * hw2 + cx, cos * hh2 + cy, z).color(r, g, b, a).endVertex();
        }
        tessellator.end();
