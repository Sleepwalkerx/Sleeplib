...
public class ShapeSize {
    ...
    public float getWidth(@Nonnull Canvas canvas) {
        return width.compute(canvas, Dimension.WIDTH);
    }
    ...
    public float getHeight(@Nonnull Canvas canvas) {
        return height.compute(canvas, Dimension.HEIGHT);
    }
    ...
    public interface Size {
        ...
        float compute(@Nonnull Canvas canvas, @Nonnull Dimension dimension);
    ...
    public static class Absolute implements Size {
        ...
        @Override
        public float compute(@Nonnull Canvas canvas, @Nonnull Dimension dimension) {
            return value;
        }
