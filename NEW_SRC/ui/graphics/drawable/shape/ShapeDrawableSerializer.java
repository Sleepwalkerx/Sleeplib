...
import com.sleepwalker.sleeplib.ui.graphics.drawable.DrawableSerializer;
...
public class ShapeDrawableSerializer extends ForgeRegistryEntry<DrawableSerializer> implements DrawableSerializer {
    ...
    @Nonnull
    @Override
    public Drawable deserializeFromXml(@Nonnull Element element) {
        ...
        return shapeSerializer.deserialize(element);
    }
}
