...
public abstract class BaseExtraScreen extends Screen implements IExtraNestedGuiEventHandler, IRoot {
    ...
    protected BaseExtraScreen(ITextComponent name) {
        super(name);
    ...
    public boolean mouseClicked(double pMouseX, double pMouseY, int pButton) {
        boolean result = IExtraNestedGuiEventHandler.super.mouseClicked(pMouseX, pMouseY, pButton);
    ...
    public boolean mouseReleased(double x, double y, int button) {
        boolean result = IExtraNestedGuiEventHandler.super.mouseReleased(x, y, button);
    ...
    public boolean mouseDragged(double mX, double mY, int button, double dragX, double dragY) {
        boolean result = IExtraNestedGuiEventHandler.super.mouseDragged(mX, mY, button, dragX, dragY);
    ...
    public boolean mouseScrolled(double pMouseX, double pMouseY, double pDelta) {
        boolean result = IExtraNestedGuiEventHandler.super.mouseScrolled(pMouseX, pMouseY, pDelta);
